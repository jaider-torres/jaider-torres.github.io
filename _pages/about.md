...
$$ {\huge \left((P)Sh_{A\mathrm{-Alg}} (X) \right)^G_{(P)Sh_{A\mathrm{-Mod}}(X),For}} \substack{\overset {(-)_B}{\longrightarrow} \\ \underset{\iota}{\hookleftarrow}} \left( (P)Sh_{G\mathrm{-Var}(B)}(X)\right)^G_{(P)Sh_{A\mathrm{-Mod}}(X),For}$$
which is somehow beautiful.a
